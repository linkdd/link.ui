...
define("classify", (function (global) {
    return function () {
        var ret, fn;
       fn = function () {
                                return {
...
define('external/require-css/normalize',[],function() {
...
define('link/actions/activate',['classify', 'jquery'], function(classify, $) {
...
define('link/actions/goto',['classify', 'jquery'], function(classify, $) {
